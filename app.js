  ...
  return {
    ...
    controller: function ($scope, $sce) {
      $scope.getIframeSrc = function (loc) {
        return 'https://www.google.com/maps/embed/v1/place?key=AIzaSyCYG3-5euwVqnAeuqUj4gJ8dfvtHOnBZBc&zoom=15&' + loc;
      };
    }
  };
});
  ...
  self.activityList = [
    {
      ...
      gmaplocation: 'q=loc:45.784136+4.882584',
...

    {
      ...
      hour: '14h',
      img: 'assets/img/tetedor.png',
      gmaplocation: 'q=La+Doua -+Gaston+Berger,+Lyon,+France',
...

    {
      ...
      gmaplocation: 'q=K-fêt,+Avenue+Jean+Capelle+Ouest,+Villeurbanne,+France',
      location: 'K-Fêt',
      need: '',
      price: '',
      text: [
